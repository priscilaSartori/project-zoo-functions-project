...
Desenvolvimento de funções que buscam informações sobre os animais do zoológico como: espécie e local de origem. Além disso, buscam dados sobre as pessoas que colaboram com a manutenção e cuidado do zoológico.
...
- Clone este repositório: `git clone git@github.com:priscilaSartori/project-zoo-functions-project.git`

- Acesse a pasta do projeto no terminal/cmd: `cd project-zoo-functions-project`
